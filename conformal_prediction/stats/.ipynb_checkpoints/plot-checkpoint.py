...
def plot(
    ...
    # for ax, (base, members) in zip(axes, groups.items()):
    #     bars      = (["normal"] + members) if normal_idx is not None else members
    #     N         = len(bars)
    #     width     = 0.8 / N
    ...
    # fig.suptitle("Prediction set mean & std per class and image type", fontsize=14, y=1.02)

    # plt.tight_layout()
    # plt.savefig("prediction_set_means.png", dpi=300, bbox_inches="tight")
    # plt.close(fig)
    # print("Figure saved to prediction_set_means.png")
